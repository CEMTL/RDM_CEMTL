;(function (global, factory) {
    ...
    hooks.defineLocale('az', {
        ...
        weekdays:
            'Bazar_Bazar ert?si_�?rs?nb? axsami_�?rs?nb?_C�m? axsami_C�m?_S?nb?'.split(
                '_'
            ),
        ...
        dayOfMonthOrdinalParse: /\d{1,2}-(inci|inci|nci|�nc�|nci|uncu)/,
        ordinal: function (number) {
            if (number === 0) {
    ...
    var months$4 = {
            format: 'leden_�nor_brezen_duben_kveten_cerven_cervenec_srpen_z�r�_r�jen_listopad_prosinec'.split(
                '_'
            ),
            standalone:
                'ledna_�nora_brezna_dubna_kvetna_cervna_cervence_srpna_z�r�_r�jna_listopadu_prosince'.split(
                    '_'
                ),
        },
        ...
        monthsRegex$2 =
            /^(leden|�nor|brezen|duben|kveten|cervenec|cervence|cerven|cervna|srpen|z�r�|r�jen|listopad|prosinec|led|�no|bre|dub|kve|cvn|cvc|srp|z�r|r�j|lis|pro)/i;
    ...
    function translate$1(number, withoutSuffix, key, isFuture) {
        ...
        switch (key) {
            ...
            case 'MM': // 9 months / in 9 months / 9 months ago
                if (withoutSuffix || isFuture) {
                    return result + (plural$1(number) ? 'mes�ce' : 'mes�cu');
                } else {
    ...
    hooks.defineLocale('cs', {
        ...
        // Otherwise parser matches '1. cervenec' as '1. cerven' + 'ec'.
        monthsStrictRegex:
            /^(leden|ledna|�nora|�nor|brezen|brezna|duben|dubna|kveten|kvetna|cervenec|cervence|cerven|cervna|srpen|srpna|z�r�|r�jen|r�jna|listopadu|listopad|prosinec|prosince)/i,
        monthsShortStrictRegex:
            /^(led|�no|bre|dub|kve|cvn|cvc|srp|z�r|r�j|lis|pro)/i,
    ...
    hooks.defineLocale('el', {
        monthsNominativeEl:
            '?a????????_Fe�????????_???t???_?p??????_?????_???????_???????_?????st??_Sept?��????_??t?�????_???��????_?e??��????'.split(
                '_'
            ),
        monthsGenitiveEl:
            '?a???a????_Fe�???a????_?a?t???_?p??????_?a???_???????_???????_?????st??_Septe��????_??t?�????_??e��????_?e?e��????'.split(
                '_'
            ),
        ...
        weekdays: '????a??_?e?t??a_???t?_?et??t?_??�pt?_?a?as?e??_S?��at?'.split(
            '_'
        ),
    ...
    hooks.defineLocale('hr', {
        months: {
            format: 'sijecnja_veljace_o�ujka_travnja_svibnja_lipnja_srpnja_kolovoza_rujna_listopada_studenoga_prosinca'.split(
                '_'
            ),
            standalone:
                'sijecanj_veljaca_o�ujak_travanj_svibanj_lipanj_srpanj_kolovoz_rujan_listopad_studeni_prosinac'.split(
                    '_'
                ),
        },
        monthsShort:
    ...
    var weekEndings =
        'vas�rnap h�tfon kedden szerd�n cs�t�rt�k�n p�nteken szombaton'.split(' ');
    ...
    hooks.defineLocale('lt', {
        months: {
            format: 'sausio_vasario_kovo_baland�io_gegu�es_bir�elio_liepos_rugpjucio_rugsejo_spalio_lapkricio_gruod�io'.split(
                '_'
            ),
            standalone:
                'sausis_vasaris_kovas_balandis_gegu�e_bir�elis_liepa_rugpjutis_rugsejis_spalis_lapkritis_gruodis'.split(
                    '_'
                ),
        ...
        weekdays: {
            format: 'sekmadieni_pirmadieni_antradieni_treciadieni_ketvirtadieni_penktadieni_�e�tadieni'.split(
                '_'
            ),
            standalone:
                'sekmadienis_pirmadienis_antradienis_treciadienis_ketvirtadienis_penktadienis_�e�tadienis'.split(
                    '_'
                ),
            isFormat: /dddd HH:mm/,
        },
    ...
    hooks.defineLocale('lv', {
        ...
        weekdays:
            'svetdiena_pirmdiena_otrdiena_tre�diena_ceturtdiena_piektdiena_sestdiena'.split(
                '_'
            ),
    ...
    hooks.defineLocale('mi', {
        ...
        monthsShort:
            'Kohi_Hui_Pou_Pae_Hara_Pipi_Hongoi_Here_Mahu_Whi-nu_Whi-ra_Haki'.split(
                '_'
            ),
    ...
    hooks.defineLocale('mt', {
        ...
        weekdays:
            'Il-Hadd_It-Tnejn_It-Tlieta_L-Erbgha_Il-Hamis_Il-Gimgha_Is-Sibt'.split(
                '_'
            ),
    ...
    var monthsNominative =
            'styczen_luty_marzec_kwiecien_maj_czerwiec_lipiec_sierpien_wrzesien_pazdziernik_listopad_grudzien'.split(
                '_'
            ),
        monthsSubjective =
            'stycznia_lutego_marca_kwietnia_maja_czerwca_lipca_sierpnia_wrzesnia_pazdziernika_listopada_grudnia'.split(
                '_'
            ),
        monthsParse$a = [
            /^sty/i,
    ...
    hooks.defineLocale('pl', {
        ...
        weekdays:
            'niedziela_poniedzialek_wtorek_sroda_czwartek_piatek_sobota'.split('_'),
    ...
    hooks.defineLocale('se', {
        months: 'oddajagem�nnu_guovvam�nnu_njukcam�nnu_cuo?om�nnu_miessem�nnu_geassem�nnu_suoidnem�nnu_borgem�nnu_cakcam�nnu_golggotm�nnu_sk�bmam�nnu_juovlam�nnu'.split(
            '_'
        ),
        monthsShort:
            'oddj_guov_njuk_cuo_mies_geas_suoi_borg_cakc_golg_sk�b_juov'.split('_'),
        weekdays:
    ...
    var months$a =
        ...
        monthsShort$7 = 'jan_feb_mar_apr_m�j_j�n_j�l_aug_sep_okt_nov_dec'.split('_');
    function plural$5(n) {
        return n > 1 && n < 5;
    }
    ...
    hooks.defineLocale('tk', {
        ...
        weekdays: '�eksenbe_Dusenbe_Sisenbe_�arsenbe_Pensenbe_Anna_Senbe'.split(
            '_'
        ),
        weekdaysShort: '�ek_Dus_Sis_�ar_Pen_Ann_Sen'.split('_'),
        weekdaysMin: '�k_Ds_Ss_�r_Pn_An_Sn'.split('_'),
        longDateFormat: {
            LT: 'HH:mm',
            LTS: 'HH:mm:ss',
            L: 'DD.MM.YYYY',
    ...
    hooks.defineLocale('tr', {
        months: 'Ocak_Subat_Mart_Nisan_Mayis_Haziran_Temmuz_Agustos_Eyl�l_Ekim_Kasim_Aralik'.split(
            '_'
        ),
        monthsShort: 'Oca_Sub_Mar_Nis_May_Haz_Tem_Agu_Eyl_Eki_Kas_Ara'.split('_'),
        weekdays: 'Pazar_Pazartesi_Sali_�arsamba_Persembe_Cuma_Cumartesi'.split(
            '_'
        ),
    ...
    hooks.defineLocale('vi', {
        ...
        monthsParseExact: true,
        weekdays: 'ch? nh?t_th? hai_th? ba_th? tu_th? nam_th? s�u_th? b?y'.split(
            '_'
        ),
        ...
        calendar: {
            ...
            lastWeek: 'dddd [tu?n tru?c l�c] LT',
            sameElse: 'L',
        },
        relativeTime: {
            future: '%s t?i',
